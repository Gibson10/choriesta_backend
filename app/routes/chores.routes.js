...
router.post('/chores/accept-applicant/:id', auth, choreController.acceptApplicant);
...
router.post('/chore-status/:choreId/:choreista', auth, choreController.choreStatus);
