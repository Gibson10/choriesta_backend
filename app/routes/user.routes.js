...
router.delete('/user/delete/:userType', authGuard, userController.deleteUserAccount);
router.get('/user/messages/get-messages', authGuard, userController.getMessages);
